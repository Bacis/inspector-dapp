...
def erc20_reward_transfer(wallet, contract_address, to_address):
    try:
        invocation = wallet.invoke_contract(
            contract_address=contract_address,
            abi=ABI,
            method="rewardUser",
            args={"user": to_address}
        ).wait()
        print(f"ERC20 reward transfer successful: {invocation}")
    except Exception as error:
        print(f"Error invoking ERC20 reward transfer: {error}")
...
def main():
    try:
        ...
        payoutWallet = import_existing_wallet()

        erc20_reward_transfer(payoutWallet, "0xA01c36F4Edb0badea839751fbA671EC61a441E46", "0x60b37A4620ac2F9589DCcc570b20D146b95B5725")
